...
image_size:tuple=(160,160)                                                  # input image size
model_address:str='pneumonia_detection_mobilenet'                                           # model address
class_labels:list=['normal','pneumonia']                                 # list of class names
