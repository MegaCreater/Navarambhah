...
image_size:tuple=(256,256)                                                  # input image size
model_address:str='ct_kidney_normal_cyst_tumor_and_stone'                                           # model address
class_labels:list=['Cyst', 'Stone', 'Normal', 'Tumor']                                # list of class names
